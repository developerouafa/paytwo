                                    ...
                                    <form action="{{route('childcat.create')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                        @csrf
                                            <div class="form-group">
                                                <input placeholder="{{__('Dashboard/sections_trans.childrenen')}}" type="text" value="{{old('title_en')}}" class="form-control @error('title_en') is-invalid @enderror" id="title_en" name="title_en">
                                                <br>
                                                <input placeholder="{{__('Dashboard/sections_trans.childrenar')}}" type="text" value="{{old('title_ar')}}" class="form-control @error('title_ar') is-invalid @enderror" id="title_ar" name="title_ar">
                                                <br>
                            ...
                            <div class="modal-body">
                                <form action="{{route('childcat.update')}}" enctype="multipart/form-data" method="post" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input placeholder="{{__('Dashboard/sections_trans.children')}}" class="form-control" name="title_{{app()->getLocale()}}" id="children" type="text">
                                    </div>
                                    <div class="form-group">
