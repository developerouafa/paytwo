...
@section('title')
    {{__('Dashboard/main-sidebar_trans.Listofinvoices')}}  {{__('Dashboard/services.Okay')}}
@stop
@section('css')
...
@section('page-header')
    <!-- breadcrumb -->
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex">
                    <h4 class="content-title mb-0 my-auto">{{__('Dashboard/main-sidebar_trans.Listofinvoices')}}  {{__('Dashboard/services.Okay')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{__('Dashboard/main-sidebar_trans.view_all')}}</span>
                </div>
            </div>
        </div>
    <!-- breadcrumb -->
                            ...
                            <table id="example-1" class="table key-buttons text-md-nowrap" data-page-length="50" style="text-align: center">
                                <thead>
                                    <tr>
                                        ...
                                        <th> {{__('Dashboard/payment_trans.Catch payment')}} </th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($fund_accountpostpaid)
                                                    @if ($fund_accountpostpaid->invoice->id == $invoice->id)
                                                        <a href="{{route('Invoices.showinvoicereceiptPostpaid',$invoice->id)}}">{{__('Dashboard/receipt_trans.viewreceipt')}}</a>
                                                    @else
                                            ...
                                            <td>
                                                @if ($invoice->invoice_status == 1)
                                                    ...
                                                    <a href="{{route('Invoices.receiptpostpaid',$invoice->id)}}" class="btn btn-primary btn-sm" target="_blank"><i class="fas fa-print"></i>{{__('Dashboard/clients_trans.cashpaymentpp')}}</a>
