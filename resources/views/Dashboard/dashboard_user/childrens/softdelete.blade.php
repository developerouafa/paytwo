        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card mg-b-20">
                    ...
                    @can('Show Children Section softdelete')
                        <div class="card-body">
                    ...
                    @endcan
                    @can('Delete Group Children softdelete')
                        @include('Dashboard.dashboard_user.childrens.delete_selectsoftdelete')
                    @endcan
                    @can('Restore Group Children')
                        @include('Dashboard.dashboard_user.childrens.restoreall')
                    @endcan
                </div>
            </div>
