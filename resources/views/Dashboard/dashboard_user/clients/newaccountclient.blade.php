...
@section('page-header')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-children mb-0 my-auto">{{__('Dashboard/main-sidebar_trans.clients')}}</h4>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="card-body">
                <div class="main-content-label mg-b-5">
                    <div class="pull-right">
                        <a class="btn btn-primary btn-sm" href="{{ route('Clients.index') }}">{{__('Dashboard/messages.back')}}</a>
                    </div>
                </div>
                <!-- Basic modal -->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" value="{{old('name')}}" autocomplete="name" class="form-control @error('name') is-invalid @enderror" id="name" name="name">
                                    </div>
                                    <div class="col-lg-6">
                                        <label>{{__('Dashboard/clients_trans.email')}}<span class="tx-danger">*</span></label>
                                        <input type="email" class="form-control" autocomplete="email" value="{{old('email')}}" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="{{__('Dashboard/clients_trans.email')}}">
                                    </div>
                                </div>
                                <br/>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <input class="form-control" autocomplete="password" data-parsley-class-handler="#lnWrapper" name="password" required type="password">
                                    </div>
                                    <div class="col-lg-6">
                                        <label>{{__('Dashboard/users.confirmpassword')}}<span class="tx-danger">*</span></label>
                                        <input class="form-control" autocomplete="confirm-password" data-parsley-class-handler="#lnWrapper" name="confirm-password" required type="password">
                                    </div>
                                </div>
                            </div>
