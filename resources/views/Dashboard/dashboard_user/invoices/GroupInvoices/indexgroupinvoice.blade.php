                                        ...
                                        <tbody>
                                            @foreach ($group_invoices as $group_invoice)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('GroupServices.show', $group_invoice->Group->id)}}">{{ $group_invoice->Group->name }}</a>
                                                    </td>
                                                    <td>
                                            ...
                                            @endforeach
                                            @can('Delete Group GroupInvoice')
                                                @include('Dashboard.dashboard_user.invoices.GroupInvoices.delete_selectgroupinvoice')
                                            @endcan
                                        </tbody>
                                    </table>
                                </div>
