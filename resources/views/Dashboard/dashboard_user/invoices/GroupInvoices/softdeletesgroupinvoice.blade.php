    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{__('Dashboard/main-sidebar_trans.deletedServicepackageinvoice')}} </span>
            </div>
        </div>
    </div>
@endsection
                        ...
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                @can('Delete All GroupInvoice softdelete')
                                    <a class="btn btn-danger" href="{{route('GroupInvoices.deleteallsoftdeletegr')}}">{{__('Dashboard/messages.Deleteall')}}</a>
                                @endcan
