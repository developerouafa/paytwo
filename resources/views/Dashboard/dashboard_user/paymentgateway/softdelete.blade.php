...
@section('title')
    {{__('Dashboard/services.deletecard')}}
@stop
@section('css')
@endsection
@section('page-header')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{__('Dashboard/services.deletecard')}} </span>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="modal" id="modaldemo9">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content modal-content-demo">
                        ...
                        <form action="{{route('paymentgateway.destroypg')}}" method="post">
                            {{ method_field('delete') }}
                            {{ csrf_field() }}
