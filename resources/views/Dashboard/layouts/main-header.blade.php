							...
							{{-- <div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu dropdown-notifications">
									<div class="menu-header-content bg-primary text-right">
                                        ...
                                        <p data-count="{{App\Models\NotificationPusher::CountNotification(auth()->user()->id)->count()}}" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 notif-count">{{App\Models\NotificationPusher::CountNotification(auth()->user()->id)->count()}}</p>
									</div>
                                    <div class="main-notification-list Notification-scroll">
                                        ...
                                        @foreach(App\Models\NotificationPusher::where('user_id',auth()->user()->id)->where('reader_status',0)->get() as $notification )
                                            <a class="d-flex p-3 border-bottom" href="#">
                                                <div class="notifyimg bg-pink">
                                                    <i class="la la-file-alt text-white"></i>
                                                </div>
