<div class="main-sidemenu">
    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('Invoices.index') }}">{{__('Dashboard/main-sidebar_trans.Listofinvoices')}} {{__('Dashboard/services.noselectionyet')}} {{__('Dashboard/payment_trans.paymentmethod')}} </a></li>
