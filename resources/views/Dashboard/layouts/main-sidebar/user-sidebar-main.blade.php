                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @cannot('sidebar Details Singleservice')
                            <li><a class="slide-item" href="{{ route('SingleInvoices.index') }}">{{__('Dashboard/main-sidebar_trans.Singleservicebill')}}</a></li>
                        @endcannot
                        @cannot('sidebar Details groupservice')
                            <li><a class="slide-item" href="{{ route('GroupInvoices.index') }}">{{__('Dashboard/main-sidebar_trans.Servicepackageinvoice')}}</a></li>
                        @endcannot
                    </ul>
                </li>
            @endcannot
