...
*/
    ...
    Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => [ 'auth', 'localeSessionRedirect', 'localizationRedirect', 'localeViewPath', 'xss', 'UserStatus']], function(){
            ...
            //* Start line chart
                ...
                ->datasets([
                    [
                        ...
                        "fill"=> false,
                        'data' => [
                            invoice::whereYear('created_at', now()->format('Y'))->whereMonth('created_at', '=', '1')->where('invoice_classify', 1)->count(),
                            invoice::whereYear('created_at', now()->format('Y'))->whereMonth('created_at', '=', '2')->where('invoice_classify', 1)->count(),
                            invoice::whereYear('created_at', now()->format('Y'))->whereMonth('created_at', '=', '3')->where('invoice_classify', 1)->count(),
                            invoice::whereYear('created_at', now()->format('Y'))->whereMonth('created_at', '=', '4')->where('invoice_classify', 1)->count(),
                            invoice::whereYear('created_at', now()->format('Y'))->whereMonth('created_at', '=', '5')->where('invoice_classify', 1)->count(),
                            invoice::whereYear('created_at', now()->format('Y'))->whereMonth('created_at', '=', '6')->where('invoice_classify', 1)->count(),
                            invoice::whereYear('created_at', now()->format('Y'))->whereMonth('created_at', '=', '7')->where('invoice_classify', 1)->count(),
                            invoice::whereYear('created_at', now()->format('Y'))->whereMonth('created_at', '=', '8')->where('invoice_classify', 1)->count(),
                            invoice::whereYear('created_at', now()->format('Y'))->whereMonth('created_at', '=', '9')->where('invoice_classify', 1)->count(),
                            invoice::whereYear('created_at', now()->format('Y'))->whereMonth('created_at', '=', '10')->where('invoice_classify', 1)->count(),
                            invoice::whereYear('created_at', now()->format('Y'))->whereMonth('created_at', '=', '11')->where('invoice_classify', 1)->count(),
                            invoice::whereYear('created_at', now()->format('Y'))->whereMonth('created_at', '=', '12')->where('invoice_classify', 1)->count(),
                        ],
                    ],
                    [
        ...
        //############################# Receipt route ##########################################
            ...
            Route::delete('/destroyrc', [ReceiptAccountController::class, 'destroy'])->name('Receipt.destroy');
            ...
            Route::get('/deleteallsoftdeletereceipt', [ReceiptAccountController::class, 'deleteallsoftdelete'])->name('Receipt.deleteallsoftdeleterc');
        ...
        //############################# Payment route ##########################################
            ...
            Route::delete('/destroypy', [PaymentaccountController::class, 'destroy'])->name('Payment.destroy');
            ...
            Route::get('/deleteallsoftdeletepaymentaccount', [PaymentaccountController::class, 'deleteallsoftdelete'])->name('Payment.deleteallsoftdeletepy');
        ...
        //############################# BankTransfer route ##########################################
            ...
            Route::delete('/destroybt', [BanktransferController::class, 'destroy'])->name('Banktransfer.destroybt');
            ...
            Route::get('/deleteallsoftdeletebanktransfer', [BanktransferController::class, 'deleteallsoftdelete'])->name('Banktransfer.deleteallsoftdeletebt');
        ...
        //############################# BankCard route ##########################################
            ...
            Route::delete('/destroypg', [PaymentgatewayController::class, 'destroy'])->name('paymentgateway.destroypg');
            ...
            Route::get('/deleteallsoftdeletepaymentgateway', [PaymentgatewayController::class, 'deleteallsoftdelete'])->name('paymentgateway.deleteallsoftdeletepg');
